...
<!-- Google Icons: https://material.io/tools/icons/ also, check out Font Awesome or Glyphicons -->
        ...
        <ul class="navbar-nav navbar-right">
            <li>
                <?php
                    ...
                    {
                        echo "<a class=\"btn btn-primary float-right\" href=\"admin/login.php\" role=\"button\">LogIn</a>";
                    }else{
                        $tmpPage = BASE_URL . "admin/logout.php";
                        echo "<a class=\"btn btn-primary float-right\" href=\"$tmpPage\" role=\"button\">LogOut</a>";
                    }
                ?>
            </li>
        </ul>
